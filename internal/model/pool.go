...
type IPPool struct {
	...
	TenantID    string    `json:"tenant_id" gorm:"type:varchar(64);not null;default:'default';uniqueIndex:idx_tenant_cidr;index"`
	CIDR        string    `json:"cidr" gorm:"column:cidr;type:varchar(100);not null;uniqueIndex:idx_tenant_cidr"` // CIDR 或 "startIP - endIP" 显示串
